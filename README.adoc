...
To try full asic synthesis with https://github.com/the-openroad-project/openroad-flow-scripts[OpenROAD] and https://github.com/yosyshq/yosys[Yosys] using https://github.com/IHP-GmbH/IHP-Open-PDK[IHP's 130nm BiCmos open PDK]:

NOTE: Please install, https://github.com/the-openroad-project/openroad-flow-scripts[OpenROAD] according to their user guide.
